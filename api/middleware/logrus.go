...
// LoggerMiddlewareLogrus is the logger middleware with logrus
func LoggerMiddlewareLogrus(logger *logruslogger.LogrusLogger) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		entry := logrus.NewEntry(logger.GetLogger()) // todo
